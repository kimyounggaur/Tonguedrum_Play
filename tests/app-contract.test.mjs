...
assert.match(html, /\.tongue-hit:hover \.tongue-outline-path,[\s\S]*?\.tongue-hit:focus-visible \.tongue-outline-path,[\s\S]*?\.tongue-hit:active \.tongue-outline-path,[\s\S]*?\.tongue-hit\.is-playing \.tongue-outline-path/, "hover, focus, active, and playing states should share the clipped outline pulse");
assert.match(html, /\.tongue-hit:hover \.tongue-glow-fill,[\s\S]*?\.tongue-hit:focus-visible \.tongue-glow-fill,[\s\S]*?\.tongue-hit:active \.tongue-glow-fill,[\s\S]*?\.tongue-hit\.is-playing \.tongue-glow-fill/, "hover, focus, active, and playing states should share the clipped glow pulse");
